...
package com.bjppartyapp.utils;

*/
/**
 * Created by Rajashekar.Nimmala on 5/30/2017.
 *//*
...
/**
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs, com.foodzerv.R.styleable.SlidingUpPanelLayout);

            if (ta != null) {
                mPanelHeight = ta.getDimensionPixelSize(com.foodzerv.R.styleable.SlidingUpPanelLayout_panelHeight, -1);
                mShadowHeight = ta.getDimensionPixelSize(com.foodzerv.R.styleable.SlidingUpPanelLayout_shadowHeight, -1);
                mParalaxOffset = ta.getDimensionPixelSize(com.foodzerv.R.styleable.SlidingUpPanelLayout_paralaxOffset, -1);

                mMinFlingVelocity = ta.getInt(com.foodzerv.R.styleable.SlidingUpPanelLayout_flingVelocity, DEFAULT_MIN_FLING_VELOCITY);
                mCoveredFadeColor = ta.getColor(com.foodzerv.R.styleable.SlidingUpPanelLayout_fadeColor, DEFAULT_FADE_COLOR);

                mDragViewResId = ta.getResourceId(com.foodzerv.R.styleable.SlidingUpPanelLayout_dragView, -1);

                mOverlayContent = ta.getBoolean(com.foodzerv.R.styleable.SlidingUpPanelLayout_overlay,DEFAULT_OVERLAY_FLAG);
            }
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(com.foodzerv.R.drawable.above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(com.foodzerv.R.drawable.below_shadow);
            }
