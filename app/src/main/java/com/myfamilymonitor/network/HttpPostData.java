package com.myfamilymonitor.network;

import android.app.ProgressDialog;
import android.util.Log;

import com.myfamilymonitor.activity.BaseActivity;
import com.myfamilymonitor.fragment.BaseFragment;
...
public class HttpPostData extends SafeAsyncTask<String> {
    ...
    private String TAG = HttpPostData.class.getSimpleName();
    ...
    private String executeRequest() {
        ...
        try {
           ...
           /* if (_url.equalsIgnoreCase(WebServiceUrls.LOGIN)) {
                ...
                connection.setRequestProperty("AuthorizationBasic " + _baseActivity.getResources().getString(R.string.auth_code));
            ...
            e.printStackTrace();
            Log.i(TAG, "-------------Web Service Exception----------:" + e.getMessage());
        }
