...
public abstract class PhoneField extends LinearLayout {
    ...
    public void PhoneFieldEditable(Boolean setEditable) {
        mSpinner.setEnabled(setEditable);
        mEditText.setKeyListener(null);
        mEditText.setCursorVisible(setEditable);
        mEditText.setPressed(setEditable);
        mEditText.setFocusable(setEditable);
    }
    ...
    public void setPhoneNumber(String rawNumber) {
        try {
            ...
            mEditText.setText(/*mPhoneUtil.format(number, PhoneNumberUtil.PhoneNumberFormat.NATIONAL)*/rawNumber);
        } catch (NumberParseException ignored) {
        }
    }
